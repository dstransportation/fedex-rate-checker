    ...
    for item in rate_details:
        ...
        for detail in item.get("ratedShipmentDetails", []):
            ...
            if amount and currency:
                ...
                results.append({"Service": service_name, "Price": f"{amount} {currency}", "Estimated Delivery": transit_estimates.get(item.get("serviceType"), "Estimate unavailable")}).get("deliveryDate", "Estimate unavailable")})
    return results
